<script lang="ts">
	...
	import { asImageSrc, type  Content, type ImageField, isFilled, type KeyTextField } from '@prismicio/client';
	import { PrismicLink } from '@prismicio/svelte';
	import ArrowIcon from '~icons/ic/baseline-arrow-outward'
...
<ul
	...
	class="grid border-b border-b-slate-100">
	{#each items as post, index (post.id + index)}
		<li
			on:mouseenter={()=> onMouseEnter(index)}
			class="content-list-item opacity-0" use:onItemEnter={index} >
...
<!--Hover Element-->
<div class="hover-reveal pointer-events-none absolute left-0 top-0 -z-10 h-[320px] w-[220px] rounded-lg
